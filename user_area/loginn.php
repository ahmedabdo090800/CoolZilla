...
{ 
    ...
    $password=password_verify($user_password, $row_data['user_password']);

    $select_query="Select * from user_table  where username='$user_username' and user_password='$password'"; 
